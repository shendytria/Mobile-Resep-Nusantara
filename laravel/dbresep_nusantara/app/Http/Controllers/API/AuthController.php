...
class AuthController extends Controller
{
    ...
    public function user(Request $request)
    {
        ...
        // Pastikan URL profile picture lengkap dengan fallback
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('profile_picture')) {
            // Hapus gambar lama hanya jika bukan default
            if ($user->profile_picture && !str_contains($user->profile_picture, 'default_profile.jpg')) {
